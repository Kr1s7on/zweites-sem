...
-- Drop tables to ensure clean installation
...
CREATE TABLE ora_products (
    ...
    model_year NUMBER(4) NOT NULL CHECK (model_year >= 1900),
...
-- Task 2, part iv
ALTER TABLE ora_orders 
ADD CONSTRAINT chk_order_status CHECK (order_status IN (1, 2, 3, 4));

-- Task 3, part a
CREATE SEQUENCE customer_id_seq START WITH 1001 INCREMENT BY 1;

-- Task 3, part b
CREATE SEQUENCE staff_id_seq START WITH 2001 INCREMENT BY 1;
...
INSERT INTO ora_stores (store_id, store_name, phone, email, street, city, state, zip_code)
VALUES (114, 'Tai Bikes', '912-276-2345', 'Tai@KeithsBikes.com', '1234 Main Street', 'Brunswick', 'GA', '31520');

-- Insert records into ora_categories
INSERT INTO ora_categories (category_id, category_name)
VALUES (11, 'Children Bicycles');
INSERT INTO ora_categories (category_id, category_name)
...
-- Task 3, part d
CREATE INDEX idx_customer_email ON ora_customers (email);
...
VALUES (2001, 'Alice', 'Johnson', 'alice.johnson@santabikes.com', '123-456-7890', 111);
INSERT INTO ora_staffs (staff_id, first_name, last_name, email, phone, store_id)
VALUES (2002, 'Bob', 'Williams', 'bob.williams@cruzbikes.com', '987-654-3210', 112);
INSERT INTO ora_staffs (staff_id, first_name, last_name, email, phone, store_id)
VALUES (2003, 'Claire', 'Smith', 'claire.smith@scarlettbikes.com', '456-789-0123', 113);
INSERT INTO ora_staffs (staff_id, first_name, last_name, email, phone, store_id) 
VALUES (2004, 'Dave', 'Brown', 'dave.b@cruzbikes.com', '123-456-7893', 112);
...
VALUES (1001, 'John', 'Doe', '123-456-7890', 'john.doe@example.com', '123 Main St', 'Springfield', 'IL', '62701');
INSERT INTO ora_customers (customer_id, first_name, last_name, phone, email, street, city, state, zip_code)
VALUES (1002, 'Jane', 'Smith', '987-654-3210', 'jane.smith@example.com', '456 Elm St', 'Chicago', 'IL', '60616');
INSERT INTO ora_customers (customer_id, first_name, last_name, phone, email, street, city, state, zip_code)
VALUES (1003, 'Mike', 'Brown', '555-123-4567', 'mike.brown@example.com', '789 Oak St', 'Houston', 'TX', '77001');
INSERT INTO ora_customers (customer_id, first_name, last_name, phone, email, street, city, state, zip_code)
VALUES (1004, 'Sara', 'Johnson', '555-987-6543', 'sara.johnson@example.com', '321 Pine St', 'Seattle', 'WA', '98101');
...
INSERT INTO ora_stocks (stock_id, store_id, product_id, quantity) VALUES (1, 101, 1, 50);
INSERT INTO ora_stocks (stock_id, store_id, product_id, quantity) VALUES (2, 101, 2, 30);
INSERT INTO ora_stocks (stock_id, store_id, product_id, quantity) VALUES (3, 102, 1, 20);
INSERT INTO ora_stocks (stock_id, store_id, product_id, quantity) VALUES (4, 102, 3, 10);
