...
VALUES (staff_id_seq.NEXTVAL, 'Alice', 'Johnson', 'alice.johnson@santabikes.com', '123-456-7890', 111);
INSERT INTO ora_staffs (staff_id, first_name, last_name, email, phone, store_id)
VALUES (staff_id_seq.NEXTVAL, 'Bob', 'Williams', 'bob.williams@cruzbikes.com', '987-654-3210', 112);
INSERT INTO ora_staffs (staff_id, first_name, last_name, email, phone, store_id)
VALUES (staff_id_seq.NEXTVAL, 'Claire', 'Smith', 'claire.smith@scarlettbikes.com', '456-789-0123', 113);
...
VALUES (customer_id_seq.NEXTVAL, 'John', 'Doe', '123-456-7890', 'john.doe@example.com', '123 Main St', 'Springfield', 'IL', '62701');
INSERT INTO ora_customers (customer_id, first_name, last_name, phone, email, street, city, state, zip_code)
